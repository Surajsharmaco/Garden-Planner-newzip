    ...
    <div className="w-full">
      <section className="pt-28 pb-20 px-5 text-center" style={{ background: "#F5F5F7" }}>
        <div className="max-w-[640px] mx-auto mt-8">
          <p className="text-[12px] font-semibold uppercase tracking-widest mb-4" style={{ color: "#6E6E73" }}>Freelancers</p>
          <motion.h1
          ...
          <motion.p
            ...
            style={{ color: "#6E6E73" }}
          >
            We work with talented freelance writers, editors, and strategists from around the world.
          </motion.p>
        </div>
      </section>

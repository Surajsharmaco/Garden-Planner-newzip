...
const schema = z.object({
  ...
  linkedinUrl: z.string().min(1, "LinkedIn or portfolio URL required"),
  coverNote: z.string().min(20, "Tell us a bit about yourself"),
});
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    ...
                    <FormField control={form.control} name="role" render={({ field }) => (
                      <FormItem>
                        <FormLabel style={{ fontFamily: "'Inter', sans-serif", fontSize: 13, fontWeight: 600, color: "#0B0B0B" }}>Role You Are Applying For</FormLabel>
                        <FormControl>
                    ...
                    <FormField control={form.control} name="linkedinUrl" render={({ field }) => (
                      <FormItem>
                        <FormLabel style={{ fontFamily: "'Inter', sans-serif", fontSize: 13, fontWeight: 600, color: "#0B0B0B" }}>LinkedIn or Portfolio URL</FormLabel>
                    ...
                    <FormField control={form.control} name="coverNote" render={({ field }) => (
                      <FormItem>
                        <FormLabel style={{ fontFamily: "'Inter', sans-serif", fontSize: 13, fontWeight: 600, color: "#0B0B0B" }}>Why GrowitBuddy?</FormLabel>
                        <FormControl>
                          <textarea
                            className="gb-input"

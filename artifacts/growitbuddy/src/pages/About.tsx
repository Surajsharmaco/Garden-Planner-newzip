    ...
    <div className="w-full pt-20 md:pt-24 pb-16 md:pb-24 lg:pb-32 px-5 md:px-8">
      <div className="container mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-[#0B0B0B]/50 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center mb-20 md:mb-32">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-[#F7F7F5] aspect-square rounded-3xl"
          >
            {/* Image placeholder */}
            <div className="w-full h-full rounded-3xl bg-[#0B0B0B]/[0.04] flex items-center justify-center">
              <span className="text-[#0B0B0B]/40">Team Photo Placeholder</span>
            </div>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 30 }}
          ...
          >
            ...
            <p className="text-base md:text-lg text-[#0B0B0B]/50 mb-6 leading-relaxed">
            ...
            <p className="text-base md:text-lg text-[#0B0B0B]/50 leading-relaxed">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-[#F7F7F5] text-[#0B0B0B] rounded-3xl p-8 md:p-16 flex flex-col md:flex-row gap-10 md:gap-12"
        >
          <div className="w-full md:w-1/3">
            <div className="w-24 h-24 md:w-32 md:h-32 bg-[#E5E5E3] rounded-full mb-6 border-4 border-[#0B0B0B]/10" />
            <h3 className="text-2xl md:text-3xl font-bold mb-2">Suraj Sharma</h3>
            <p className="text-[#0B0B0B] font-semibold mb-6">Founder & CEO</p>
            <div className="flex gap-4">
              <a href="#" className="text-[#0B0B0B]/40 hover:text-[#0B0B0B] transition-colors underline">LinkedIn</a>
              <a href="#" className="text-[#0B0B0B]/40 hover:text-[#0B0B0B] transition-colors underline">Twitter / X</a>
            </div>
          </div>
          <div className="w-full md:w-2/3">
            <h4 className="text-xl md:text-2xl font-bold mb-4">The Origin</h4>
            <p className="text-[#0B0B0B]/60 text-base md:text-lg leading-relaxed mb-6">
            ...
            <p className="text-[#0B0B0B]/60 text-base md:text-lg leading-relaxed">

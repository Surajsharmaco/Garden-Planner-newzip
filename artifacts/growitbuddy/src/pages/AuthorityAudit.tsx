      ...
      <div className="container mx-auto px-4 md:px-8 max-w-4xl">
        {!result ? (
          <>
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold mb-6 text-[#0A0A0A]">Authority Audit.</h1>
            ...
            <motion.div
              ...
              className="bg-[#F4F4F4] border border-black/8 shadow-sm rounded-3xl p-8 md:p-12"
            >
              <Form {...form}>
                <form onSubmit={form.handleSubmit(calculateScore)} className="space-y-8">
                  ...
                  <Button type="submit" size="lg" className="w-full h-14 text-lg bg-[#0A0A0A] text-white" disabled={isCalculating}>
          ...
          <motion.div
            ...
            className="bg-[#F4F4F4] border border-black/8 shadow-sm rounded-3xl p-8 md:p-16 text-center"
          >
            <h2 className="text-3xl font-bold mb-12 text-[#0A0A0A]">Your Authority Profile</h2>
            ...
            <div className="relative w-64 h-64 mx-auto mb-12 flex items-center justify-center rounded-full border-[16px] border-black/8 shadow-inner">
              ...
              <div className="text-center">
                <span className="text-6xl font-black text-[#0A0A0A]">{result.score}</span>
                <span className="text-[#9E9E9E] block text-lg font-medium">/ 100</span>
              </div>
            </div>
            ...
            <div className="bg-[#0A0A0A] text-white p-8 rounded-2xl">
              ...
              <Link href="/contact">
                <button className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-[#0A0A0A] text-black font-bold text-lg
            ...
            <button onClick={() => setResult(null)} className="mt-8 text-[#525252] hover:text-black font-medium underline underline-offset-4">
              Retake Audit
            </button>
          </motion.div>
        )}

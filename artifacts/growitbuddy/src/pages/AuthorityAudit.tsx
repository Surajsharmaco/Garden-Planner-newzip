    ...
    <div className="w-full">
      <section className="pt-28 pb-20 px-5 text-center" style={{ background: "#1D1D1F" }}>
        <div className="max-w-[640px] mx-auto mt-8">
          <p className="text-[12px] font-semibold uppercase tracking-widest mb-4" style={{ color: "rgba(255,255,255,0.45)" }}>Audit</p>
          <motion.h1
          ...
          >
            Answer 8 questions and get a personalised breakdown of your current authority leverage.
          </motion.p>
        </div>
      </section>

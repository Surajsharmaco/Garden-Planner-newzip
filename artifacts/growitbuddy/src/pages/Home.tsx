...
export default function Home() {
  return (
    <div className="flex flex-col w-full overflow-hidden">
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center justify-center pt-28 pb-16 px-5 md:pt-32 md:pb-24 md:px-8 overflow-hidden">
        ...
        {/* Floating Orbs */}
        <div className="absolute top-20 right-[10%] w-[300px] h-[300px] bg-accent/10 rounded-full blur-3xl animate-float-slow z-0"></div>
        <div className="absolute bottom-20 left-[10%] w-[400px] h-[400px] bg-accent/5 rounded-full blur-3xl animate-float-slow-reverse z-0"></div>
        
        <HeroScene />
        
        <div className="container mx-auto z-10 max-w-5xl lg:text-left text-center">
          <motion.div
            initial="hidden"
            animate="visible"
            variants={stagger}
            className="flex flex-col lg:items-start items-center lg:w-2/3"
          >
            ...
            <motion.h1 variants={fadeIn} className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold tracking-tight leading-[1.1] mb-8 text-balance">
      ...
      <section className="py-16 px-5 md:py-24 md:px-8 lg:py-32 bg-foreground text-white">
      ...
      {/* Framework Section */}
      <section className="py-16 px-5 md:py-24 md:px-8 lg:py-32 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">The GrowitBuddy Framework</h2>
            ...
            {[
              ...
              <TiltCard key={i}>
                <motion.div
                  ...
                  className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow relative overflow-hidden group h-full"
                >
      ...
      {/* Case Studies */}
      <section className="py-16 px-5 md:py-24 md:px-8 lg:py-32">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">Proof of Work</h2>
            ...
            <Link href="/work">
              <Button variant="outline" className="h-12 px-6 w-full md:w-auto">View All Case Studies</Button>
            </Link>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-16 px-5 md:py-24 md:px-8 lg:py-32 bg-foreground text-white text-center">
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            <Link href="/contact">
              <Button size="lg" className="w-full sm:w-auto h-16 px-10 text-xl bg-accent text-foreground hover:bg-accent/90 hover:scale-105 transition-all">
                Book Strategy Call
              </Button>
            </Link>
          </motion.div>

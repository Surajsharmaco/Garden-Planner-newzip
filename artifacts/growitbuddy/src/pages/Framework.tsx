    ...
    <div className="w-full bg-white">
      <section className="pt-28 pb-20 px-6 md:px-12 lg:px-20" style={{ background: "#F6F6F6", borderBottom: "1px solid rgba(0,0,0,0.08)" }}>
        <div className="max-w-[1200px] mx-auto">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] mb-5" style={{ color: "rgba(0,0,0,0.35)", fontFamily: "'Instrument Sans', sans-serif" }}>Framework</p>
          <motion.h1
          ...
          >
            A battle-tested 4-step system for engineering category dominance that compounds.
          </motion.p>
        </div>
      </section>

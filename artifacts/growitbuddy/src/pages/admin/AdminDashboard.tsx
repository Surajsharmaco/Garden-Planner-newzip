...
const TYPE_COLORS: Record<string, string> = {
  contact: "#2563eb", creator: "#7c3aed", freelancer: "#059669",
  "full-time": "#d97706", newsletter: "#db2777",
};
                ...
                return (
                  <div key={type}>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[12px] font-semibold text-[#0B0B0B] capitalize">{type}</span>

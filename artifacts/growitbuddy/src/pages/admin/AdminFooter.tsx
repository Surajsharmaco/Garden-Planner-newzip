...
const DEFAULTS: FooterData = {
  ...
  instagram: "",
  columns: [
    { title: "Services", links: [{ label: "Founder Brand", path: "/services" }, { label: "Creator Partnerships", path: "/services" }, { label: "Content Studio", path: "/services" }, { label: "Authority Audit", path: "/authority-audit" }] },
    { title: "Company", links: [{ label: "Work", path: "/work" }, { label: "Framework", path: "/framework" }, { label: "About", path: "/about" }, { label: "Contact", path: "/contact" }] },
    { title: "Join Us", links: [{ label: "For Creators", path: "/creators" }, { label: "For Freelancers", path: "/freelancers" }, { label: "Full-Time Roles", path: "/full-time" }] },
  ],
